...
describe('resource users', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.users.create({ body: [{ email: 'dev@stainless.com' }] });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.users.create({
      body: [{ email: 'dev@stainless.com', role: 'global:member' }],
    });
  });
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.users.retrieve('id', { includeRole: true }, { path: '/_stainless_unknown_path' }),
  ...
  test.skip('updateRole: only required params', async () => {
    const responsePromise = client.users.updateRole('id', { newRoleName: 'global:member' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('updateRole: required and optional params', async () => {
    const response = await client.users.updateRole('id', { newRoleName: 'global:member' });
  });
});
